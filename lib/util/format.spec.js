...
import { inAddress, inBlockNumber, inData, inHex, inNumber10, inNumber16, outBlock, outAddress, outDate, outNumber } from './format';
  ...
  describe('outBlock', () => {
    it('formats a block with all the info converted', () => {
      expect(
        ...
        totalDifficulty: new BigNumber('0x104'),
