...
export default class Contract {
  ...
  call (func, options, ...values) {
    return this._eth.eth
      .call(this._encodeOptions(options))
      .then((encoded) => func.decodeOutput(encoded));
  }

  estimateGas (func, options, ...values) {
    return this._eth.eth.estimateGas(this._encodeOptions(options));
  }

  sendTransaction (func, options, ...values) {
    return this._eth.eth.sendTransaction(this._encodeOptions(options));
  }
}
