...
describe('contract/Contract', () => {
  ...
  describe('bindings', () => {
    ...
    describe('signAndSendTransaction', () => {
      beforeEach(() => {
        scope = mockRpc([{ method: 'personal_signAndSendTransaction', reply: { result: ['hashId'] } }]);
      });
    ...
    describe('call', () => {
      it('encodes options and mades an eth_call call', () => {
        scope = mockRpc([{ method: 'eth_call', reply: { result: RETURN1 } }]);
      ...
      it('encodes options and mades an eth_call call (multiple returns)', () => {
        scope = mockRpc([{ method: 'eth_call', reply: { result: `${RETURN1}${RETURN2}` } }]);
